 ...
 */
int32_t receive_rpc_from_libqaul_queued_length(void);
 ...
 */
int32_t send_rpc_to_libqaul_count(void);
 ...
 * -2 : message is too big
 */
int32_t send_sys_to_libqaul(const uint8_t *message, uint32_t message_length);
 ...
 * -3 : buffer pointer is null
 */
int32_t receive_sys_from_libqaul(unsigned char *buffer, uint32_t buffer_length);
